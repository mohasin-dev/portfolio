...
@section('content')
    ...
    <a href="{{ route('admin.dashboard') }}" class="btn btn-danger waves-effect">BACK</a>
            <a href="{{ route('admin.profile.edit',$admin->id) }}" class="btn btn-success waves-effect pull-right">Update Profile
                {{-- <i class="material-icons">done</i> --}}
                {{-- <span>Update Profile</span> --}}
            </a>
            <a href="{{ route('admin.password.edit') }}" class="btn btn-success waves-effect pull-right">Change Password
                {{-- <i class="material-icons">done</i> --}}
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> <!--bg-amber -->
                        ...
                        <div class="body">
                            <img class="img-responsive thumbnail" src="{{ asset('storage/user/' . $admin->avatar) }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
